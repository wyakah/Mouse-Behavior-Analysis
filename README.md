...
- **Test selection:** Three Chamber is available; Stereotypy is a planned pipeline. Unsupported test IDs cannot start analysis.
...
1. **Choose test:** select Three Chamber, or continue your saved setup. Stereotypy is marked as planned.
